...
RSpec.describe Piece, type: :model do
  it 'should detect horizontal obstructions' do
    ...
    expect(piece1.is_obstructed?(7, 3)).to be true
    expect(piece2.is_obstructed?(1, 3)).to be true
  end
  ...
  it 'should detect vertical obstructions' do
    ...
    expect(piece1.is_obstructed?(5, 1)).to be true
    expect(piece2.is_obstructed?(5, 7)).to be true
  end
  ...
  it 'should detect diagonal obstructions' do
    ...
    expect(piece1.is_obstructed?(2, 2)).to be true
    expect(piece2.is_obstructed?(5, 5)).to be true
    expect(piece1.is_obstructed?(6, 2)).to be true
    expect(piece3.is_obstructed?(3, 5)).to be true
  end
  ...
  it 'should detect path is not obstructed' do
    ...
    expect(piece1.is_obstructed?(6, 6)).to be false
    expect(piece1.is_obstructed?(4, 6)).to be false
    expect(piece1.is_obstructed?(6, 4)).to be false
  end
end
